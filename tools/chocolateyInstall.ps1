...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-24.0.5.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '2A8A89314EE11A06A3D45718570DD3269BF2A16C8D6237DA16759639AE923BB0'
    ChecksumType  = 'sha256'
}
