...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-27.2.1.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '84A407EAACDB36464B5ED0971B09BF74F531A979B59AFA46C47C88F4D84440CD'
    ChecksumType  = 'sha256'
}
