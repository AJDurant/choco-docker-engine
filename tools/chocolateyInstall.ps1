...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-25.0.4.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '7EF75DE357525B19C6F60098CBA75571AA286EB56206CDA121C5693D63D28386'
    ChecksumType  = 'sha256'
}
