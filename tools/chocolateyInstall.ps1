...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-27.1.0.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '904821189CAC22BF2AB911931F6A49AC1E8B454E4DE5166828CEB435C3C2F4EA'
    ChecksumType  = 'sha256'
}
