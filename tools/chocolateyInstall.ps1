...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-27.1.1.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '978D3BA0F8440173469580F9C17F44FE28FCEF3A59AB87C32D42A2D9A2853C26'
    ChecksumType  = 'sha256'
}
