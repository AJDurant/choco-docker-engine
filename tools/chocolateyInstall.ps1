...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-25.0.2.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = 'B1E87F0C2091756096D1DF989D2B160274663791718888C12702CF584EB3F84C'
    ChecksumType  = 'sha256'
}
