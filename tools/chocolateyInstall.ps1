...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-27.3.0.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = 'A3E1F0E85126A5E51E0FDBEA5EA2E63D784DCDDB8DCA236D401B10321C897D50'
    ChecksumType  = 'sha256'
}
