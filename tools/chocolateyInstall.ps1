...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-25.0.5.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = 'F2FB3ABBCB30F5B31523D0A7BEA76EE82FACD79F7EF701B16231CC340A75B06D'
    ChecksumType  = 'sha256'
}
