...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-26.1.0.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = 'AA2BAFA9FDE1B33163297DECDC9DEC872E5AA378A826EF387DC6AF918358B4C6'
    ChecksumType  = 'sha256'
}
