...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-28.3.1.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '8360CF63AC342B1ED29C9EC9CB816209E13B7CA381CCF1F7B602DD8284024382'
    ChecksumType  = 'sha256'
}
