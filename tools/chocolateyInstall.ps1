...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-24.0.1.zip" # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  Checksum       = '9C32DA693E0525B92C31978E4C9E58E69C6DE65199C5D1A2D4A40139754C0411'
  ChecksumType   = 'sha256'
}
