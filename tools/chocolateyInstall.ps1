...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-25.0.3.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '5EE24222F3C8BD1AF7D48939B4FF361143E3CFE8EA33087A5D809D9263BF3904'
    ChecksumType  = 'sha256'
}
