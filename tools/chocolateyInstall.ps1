...
$url = "https://download.docker.com/win/static/stable/x86_64/docker-27.0.3.zip" # download url, HTTPS preferred
...
$packageArgs = @{
    ...
    Checksum      = '1EF457D11BE0346725F25A198672C7A991D6C5A2303541C43EC85C219FAE51EE'
    ChecksumType  = 'sha256'
}
